...
<script>
  ...
  function scrollToRolunk() {
    ...
    if (rolunkSection) {
      rolunkSection.scrollIntoView({ behavior: 'smooth' });
    }
  }
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <div class="carousel-caption">
        <h5>Éttermek Szegeden</h5>
        <p>Szegedi éttermek értékelés szerinti sorbarenedezése és helyileg láthatósága, </p>
        <p><a href="#" class="btn btn-warning mt-3">Tudj meg többet!</a></p>
      </div>
    </div>
